...
static const unsigned int gappovv   = 5;        /* horiz outer gap between windows and screen edge on vertical monitor */
...
static const char *fonts[]          = { "Iosevka:size=16", "Font Awesome 5 Pro Solid:size=12" };
...
static Key keys[] = {
	...
	{ MODKEY,			XK_p,			spawn,		SHCMD("pick") },
	{ MODKEY|ShiftMask,		XK_p,			togglepetwindow,		{0} },
